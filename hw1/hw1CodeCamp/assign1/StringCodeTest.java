...
public class StringCodeTest {
	...
	@Test
	//empty string, weird char
	public void testInter2() {
	    assertEquals(true, StringCode.stringIntersect("123", "&1&2&3", 1));
	    assertEquals(false, StringCode.stringIntersect("123", "&12&3", 3));
	    assertEquals(false, StringCode.stringIntersect("", "123", 1));
	    assertEquals(true, StringCode.stringIntersect("123", "1$23123", 3));
	}
