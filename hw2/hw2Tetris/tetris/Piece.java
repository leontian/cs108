...
public class Piece {
    ...
    public Piece computeNextRotation() {
        ...
        Arrays.copyOf(this.body, this.body.length);
//        System.out.println(nextArray[0].toString());
//        System.out.println(nextArray[1].toString());
//        System.out.println(nextArray[2].toString());
//        System.out.println(nextArray[3].toString());
        for (TPoint n:nextArray) {
            int temp = n.y;
            n.y = n.x;
            n.x = -temp + this.height -1;
        }
//        System.out.println(nextArray[0].toString());
//        System.out.println(nextArray[1].toString());
//        System.out.println(nextArray[2].toString());
...
//        System.out.println("-----------------");
    ...
    public boolean equals(Object obj) {
        ...
        return (this.height == other.getHeight()) &&
                ...
                Arrays.equals(other.getSkirt(), this.skirt); //TODO sufficient for now 
    }
    ...
    private static Piece makeFastRotations(Piece root) {
        ...
        //int i = 0; //TODO
        while (true) {
            nextRotation = currentPiece.computeNextRotation();
